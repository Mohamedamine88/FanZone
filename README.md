...
| Match tickets |
|---------------|
| ![Match tickets](screenshots/Upcoming_Matches.png) |

| Flight bookings |
|---------------|
| ![Flight bookings](screenshots/Flight_bookings.png) |

| Hotel bookings |
|---------------|
| ![Hotel bookings](screenshots/Luxury_Hotels.png) |

| Activities page |
|---------------|
| ![Activities page](screenshots/Activities_Page.png) |

### AI Chatbot
| Chatbot Interface |
|-------------------|
| ![Chatbot](screenshots/Chatbot_Assistant.png) |
